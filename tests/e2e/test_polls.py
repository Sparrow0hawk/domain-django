...
from tests.e2e.client import QuestionRepr, AppClient, ChoiceRepr
...
def test_poll_shows_question_and_choices(app_client: AppClient, live_server: LiveServer, page: Page) -> None:
    app_client.add_questions(
        QuestionRepr(
            id=1,
